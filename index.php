...
<body>
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="?">Fuzzy SAW</a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="?m=alternatif"><span class="glyphicon glyphicon-chevron-right"></span> Alternatif</a></li>
                            <li><a href="?m=rel_alternatif"><span class="glyphicon glyphicon-chevron-right"></span> Nilai Alternatif</a></li>
                        </ul>
                    </li>
    ...
    <footer class="footer bg-primary">
        <div class="container">
            <p> &copy; <?= date('Y') ?> Baznas Kota Padang <em class="pull-right"></em></p>
        </div>
    </footer>
